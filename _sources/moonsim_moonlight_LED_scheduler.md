...
- Download _<span style="font-variant:small-caps;">MoonSim</span>: Moonlight scheduler_ in {ref}`content:lightbox:download`.
## Key features
...
- Certain habitats are characterized by unique wavelength-dependent attenuation, which researchers may consider emulating. _<span style="font-variant:small-caps;">MoonSim</span> Moonlight scheduler_ provides the option to adjust the relative intensity of the RGBW channels ({numref}`habitat`).
